...
#ifndef INFINITUM_QT_INFINITUMUNITS_H
#define INFINITUM_QT_INFINITUMUNITS_H
...
/** Infinitum unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class InfinitumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit InfinitumUnits(QObject *parent);

    /** Infinitum units.
      @note Source: https://en.infinitum.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        INF,
...
typedef InfinitumUnits::Unit InfinitumUnit;

#endif // INFINITUM_QT_INFINITUMUNITS_H
