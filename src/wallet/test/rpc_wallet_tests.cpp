...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CInfinitumAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CInfinitumAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CInfinitumAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CInfinitumAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CInfinitumAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CInfinitumAddress(arr[0].get_str()).Get() == demoAddress.Get());
