...
{
    BOOST_CHECK(TestSplitHost("www.infinitum.org", "www.infinitum.org", -1));
    BOOST_CHECK(TestSplitHost("[www.infinitum.org]", "www.infinitum.org", -1));
    BOOST_CHECK(TestSplitHost("www.infinitum.org:80", "www.infinitum.org", 80));
    BOOST_CHECK(TestSplitHost("[www.infinitum.org]:80", "www.infinitum.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:44144", "127.0.0.1", 44144));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:44144", "127.0.0.1", 44144));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:44144", "::ffff:127.0.0.1", 44144));
    BOOST_CHECK(TestSplitHost("[::]:44144", "::", 44144));
    BOOST_CHECK(TestSplitHost("::44144", "::44144", -1));
    BOOST_CHECK(TestSplitHost(":44144", "", 44144));
    BOOST_CHECK(TestSplitHost("[]:44144", "", 44144));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:44144", "127.0.0.1:44144"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:44144", "[::]:44144"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
