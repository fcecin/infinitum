...
#ifndef INFINITUM_TEST_SCRIPTNUM10_H
#define INFINITUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Infinitum Core 0.10.0, for cross-comparison.
 */
public:
