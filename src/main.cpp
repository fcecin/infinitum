...
#if defined(NDEBUG)
# error "Infinitum cannot be compiled without assertions."
#endif
 ...
 */
// Infinitum:: our version "1" blocks are the new default blocks -- this is unused code right now REMOVEME
...
const string strMessageMagic = "Infinitum Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s INF additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("infinitum-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Infinitum:: all stuff hardcoded for block versions 1-4 is on the new block version "1"
    //
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    // Infinitum:: our version "1" blocks are the new default blocks
