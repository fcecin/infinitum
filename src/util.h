 ...
 */
#ifndef INFINITUM_UTIL_H
#define INFINITUM_UTIL_H
...
extern const char * const INFINITUM_CONF_FILENAME;
extern const char * const INFINITUM_PID_FILENAME;
...
{
    std::string s = strprintf("infinitum-%s", name);
