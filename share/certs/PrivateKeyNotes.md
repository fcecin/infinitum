...
unlocked to sign the Infinitum-Qt.app bundle.
...
allowing somebody to distribute a Infinitum-Qt.app or infinitum-qt-setup.exe with a valid
...
that the infinitum-qt.exe file inside the installer had not been tampered with.
