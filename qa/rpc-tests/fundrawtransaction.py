...
class RawTransactionsTest(InfinitumTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid infinitum address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid infinitum address" in e.error['message'])
