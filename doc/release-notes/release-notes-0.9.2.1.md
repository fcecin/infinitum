Infinitum Core version 0.9.2.1 is now available from:

  https://infinitum.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 INF to 0.01 INF
...
- Fix "Start infinitum on system login"
