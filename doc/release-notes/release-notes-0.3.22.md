Download URL: https://sourceforge.net/projects/infinitum/files/Infinitum/infinitum-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 INF fee schedule (users still pay 0.01 INF per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #infinitum00 - #infinitum99
