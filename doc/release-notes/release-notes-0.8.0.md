Infinitum-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/infinitum/files/Infinitum/infinitum-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Infinitum
...
New/changed settings (command-line or infinitum.conf file)
--------------------------------------------------------
