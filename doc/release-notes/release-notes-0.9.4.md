Infinitum Core version 0.9.4 is now available from:

  https://infinitum.org/bin/0.9.4/
...
this update is incompatible with the Infinitum system and could lead to consensus
forks.

Infinitum Core released binaries from https://infinitum.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~infinitum/+archive/ubuntu/infinitum
- A third-party or self-compiled Infinitum Core

upgrade to Infinitum Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
