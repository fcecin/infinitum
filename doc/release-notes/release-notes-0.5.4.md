Infinitum version 0.5.4 is now available for download at:
http://sourceforge.net/projects/infinitum/files/Infinitum/infinitum-0.5.4/
...
http://gitorious.org/infinitum/infinitumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Infinitum-Qt notifications under Growl 1.3.
Increase required age of Infinitum-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxInfinitum properly when installing Infinitum-Qt over it. (Windows)
