Infinitum Core version 0.10.4 is now available from:

  <https://infinitum.org/bin/infinitum-core-0.10.4/>
...
- #6953 `43c2789` Split infinitum-tx into its own package
- #6953 `dfe0d4d` Include infinitum-tx binary on Debian/Ubuntu
