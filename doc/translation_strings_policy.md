...
This document provides guidelines for internationalization of the Infinitum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `infinitum_en.ts` remains unchanged.
