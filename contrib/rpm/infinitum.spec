...
License:	MIT
URL:		https://infinitum.org/
Source0:	https://infinitum.org/bin/infinitum-core-%{version}/infinitum-%{version}.tar.gz
...
%{_sbindir}/semanage port -a -t infinitum_port_t -p tcp 8332
%{_sbindir}/semanage port -a -t infinitum_port_t -p tcp 8333
%{_sbindir}/semanage port -a -t infinitum_port_t -p tcp 18332
%{_sbindir}/semanage port -a -t infinitum_port_t -p tcp 18333
